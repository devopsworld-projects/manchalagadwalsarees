...
const About = () => {
  return (
    <div className="min-h-screen">
      <PageMeta
        title="About Us"
        description="Learn about Manchala Gadwal Sarees — our passion for preserving India's textile heritage through handcrafted sarees."
        canonicalPath="/about"
      />
      <AnnouncementBar />
      <Navbar /><Breadcrumbs />
      <main>
        ...
        <section className="container py-16 max-w-3xl">
          <div className="space-y-6 font-body text-muted-foreground leading-relaxed">
            <p>
              <strong className="text-foreground font-display text-xl">Manchala Gadwal Sarees</strong> is a celebration of the modern Indian woman who carries her heritage with pride and grace.
            </p>
            <p>
